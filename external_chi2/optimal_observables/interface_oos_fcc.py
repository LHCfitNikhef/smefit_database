...
class OptimalWWFCC161:
    def __init__(self, coefficients, rge_dict=None):
        ...
        if rge_dict is not None:
            rgemat, coefficients = compute_rge_matrix(coefficients, rge_dict, scale=161.0)
        else:
            rgemat = None
...
class OptimalWWFCC240:
    def __init__(self, coefficients, rge_dict=None):
        ...
        if rge_dict is not None:
            rgemat, coefficients = compute_rge_matrix(coefficients, rge_dict, scale=240.0)
        else:
            rgemat = None
...
class OptimalWWFCC365:
    def __init__(self, coefficients, rge_dict=None):
        ...
        if rge_dict is not None:
            rgemat, coefficients = compute_rge_matrix(coefficients, rge_dict, scale=365.0)
        else:
            rgemat = None
