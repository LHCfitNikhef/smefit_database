...
html_files = ['/home/marion/eeWW_SM_ILC/crossx.html', '/home/marion/eeWW_NP2_ILC/crossx.html', '/home/marion/eeWW_NP4_ILC/crossx.html']
        ...
        with open(html_file, 'r', encoding='utf-8') as source_file:
            ...
            for line in source_file:
                ...
                if match:
                    ...
                    if has_sq and '_' not in label:  # Single segment and "_sq" is present
                    ...
                    output_file.write(f"{modified_label}\t{number1}\t{number2}\t{fourth_column}\n")